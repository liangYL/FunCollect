...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    NSLog(@"减速完成%ld",(long)i);
    [self.delegate titleScrOrClickindex:i];
}
...
- (void)setUpAllTitle
{
    ...
    // 设置标题滚动视图的内容范围
    UILabel *lastLabel = self.titleLabels.lastObject;
    _titleScrollView.contentSize = CGSizeMake(CGRectGetMaxX(lastLabel.frame)+_titleMargin, 0);
