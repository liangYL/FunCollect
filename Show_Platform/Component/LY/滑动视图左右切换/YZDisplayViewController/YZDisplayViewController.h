 ...
 *  我添加的视图切换事件
 */
@protocol YZDisplayViewControllerDelegate <NSObject>

-(void)titleScrOrClickindex:(NSInteger)index;
 ...
 *  我添加的点击事件的代理
 */
@property(nonatomic,weak)id<YZDisplayViewControllerDelegate>delegate;
