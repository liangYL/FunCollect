...
- (void)drawRect:(CGRect)rect
{
    ...
    [@"画圆：" drawInRect:CGRectMake(10, 20, 80, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画线及孤线：" drawInRect:CGRectMake(10, 80, 100, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画矩形：" drawInRect:CGRectMake(10, 120, 80, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画扇形和椭圆：" drawInRect:CGRectMake(10, 160, 110, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画三角形：" drawInRect:CGRectMake(10, 220, 80, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画圆角矩形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 300, 100, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:@{NSForegroundColorAttributeName: [UIColor redColor], NSFontAttributeName:font}];
