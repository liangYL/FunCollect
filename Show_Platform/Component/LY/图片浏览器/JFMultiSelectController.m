...
#import "JFMultiSelectController.h"
#import "JFImagePickerController.h"

@interface JFMultiSelectController () <JFImagePickerDelegate, UICollectionViewDelegate, UICollectionViewDataSource>

@end

@implementation JFMultiSelectController {
